// ABOUTME: This file contains the Footer component with site information and links
// ABOUTME: It provides the site footer with navigation links and copyright information
