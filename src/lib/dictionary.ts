 ...
 * 
 * Checks if the Hunspell affix file follows the required format with SET directive
 * and necessary sections for Spanish morphology rules.
 * 
 ...
 * @example
 * try {
 *   validateAffixFile(affixContent);
 *   console.log('Affix file is valid');
 * } catch (error) {
 *   console.error('Invalid affix file:', error.message);
 * }
 */
 ...
 * 
 * Checks if the Hunspell dictionary file follows the required format with
 * word count as the first line and correct number of entries.
 * 
 ...
 * @example
 * try {
 *   validateDictionaryFile(dictionaryContent);
 *   console.log('Dictionary file is valid');
 * } catch (error) {
 *   console.error('Invalid dictionary file:', error.message);
 * }
 */
 ...
 * 
 * Makes sure both Hunspell files are valid individually and that they are
 ...
 *   console.log('Dictionary format is valid');
 * } catch (error) {
 *   console.error('Invalid dictionary format:', error.message);
 * }
 */
